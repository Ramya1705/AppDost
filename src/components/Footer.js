...
import { Sparkles, Linkedin, Twitter, Instagram, Send, Mail, Globe } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
              ...
              <li><a href="#careers" onClick={(e) => handleNavClick(e, '#careers')} className="hover:text-blue-400 transition-colors">Careers</a></li>
